...
TOKEN = '7235516122:AAH-Yu-7DeGD7-nsJ17M9IOpCve9mSijWdI'
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        bot.reply_to(message, "*Maa Chod Do Bgmi Ki. POWER OF @VIKAS_YADAV29*", parse_mode='Markdown')
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/apexmodspvt/347*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact @VIKAS_YADAV29*", parse_mode='Markdown')
